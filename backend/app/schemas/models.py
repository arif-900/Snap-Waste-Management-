...
class ComplaintResponse(BaseModel):
    ...
    address: str | None = Field(None, description="Human-readable address resolved from coordinates")
    ...
    reporterPhone: str | None = Field(None, description="Optional phone number of reporting citizen")
    reporterNotes: str | None = Field(None, description="Citizen comments or context")
    ...
    imageHash: str | None = Field(None, description="Perceptual difference hash of the waste image")
...
class ImageAnalysisResponse(BaseModel):
    ...
    duplicate_id: str | None = Field(None, description="The ID of the existing duplicate report")
